...
# Sources
SOURCE_AMPLITUDE_n = 0.01
SOURCE_AMPLITUDE_p_e = 0.01
SOURCE_AMPLITUDE_p_i = 0.01
...
source_profile = exp(-x / SOURCE_DECAY_LENGTH)
...
L_n = (
    ...
    + DT * SOURCE_AMPLITUDE_n * source_profile * v_n * dx
)
...
L_p_e = (
    ...
    + DT * SOURCE_AMPLITUDE_p_e * source_profile * v_p_e * dx
)
...
L_p_i = (
    ...
    + DT * SOURCE_AMPLITUDE_p_i * source_profile * v_p_i * dx
)
...
output_file = VTKFile(f"DriftPlane_Te_Ti_ForwardEuler_{BOUNDARY_TYPE}.pvd")
...
print(f"Done. Total wall-clock time: {time.time() - start_time} seconds")
